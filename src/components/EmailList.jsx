...
export default function EmailList({ activeId, onSelect, sidebarCollapsed, onExpandSidebar, mobileOpen, onMobileClose }) {
  ...
  return (
    <>
      ...
      <div className={`${styles.emailList} ${mobileOpen ? styles.mobileOpen : ''}`}>
